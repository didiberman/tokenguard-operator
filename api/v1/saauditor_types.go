...
type SAAuditorSpec struct {
	...
	// foo is an example field of SAAuditor. Edit saauditor_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// SAAuditorStatus defines the observed state of SAAuditor.
type SAAuditorStatus struct {
	...
	// conditions represent the current state of the SAAuditor resource.
